...
char *compute_get_request(char *host, char *url, char *query_params, char *auth,
...
char *compute_post_request(char *host, char *url, char* content_type, char **body_data,
                            int body_data_fields_count, char* auth, char **cookies, int cookies_count)
{
    char *message = calloc(BUFLEN, sizeof(char));
    char *line = calloc(LINELEN, sizeof(char));
...
char *compute_delete_request(char *host, char *url, char *query_params, char *auth,
                            char **cookies, int cookies_count)
{
